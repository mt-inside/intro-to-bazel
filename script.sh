...
edit hello.go
bazel run //:hello # doesn't know about the dep
bazel run //:gazelle
bazel run //:hello # now doesn't know about grpc, which is our first external dep
